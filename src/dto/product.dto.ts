...
const productVariantSchema = yup.object({
    variantName: yup.string().trim().required("Variant name is required"),

    attributes: yup.array().of(specItemSchema).default([]),
...
export const updateProductSchema = yup.object({
    ...
    isHide: yup.number().oneOf(validStatus as any, "Invalid evaluation status"),
